...
<head>
   ...
   <title>watch video | AR Tube</title>
...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <form action="" method="post" class="flex">
         ...
         <a href="playlist.php?get_id=<?= $fetch_content['playlist_id']; ?>" class="inline-option-btn">view playlist</a>
         <?php
            if($verify_likes->rowCount() > 0){
         ?>
         <button type="submit" name="like_content"><i class="fas fa-heart" style="color:red;"></i><span>liked</span></button>
         <?php
         }else{
         ?>
         <button type="submit" name="like_content"><i class="fa-solid fa-heart fa-beat" style="--fa-animation-duration: 0.5s;" ></i><span>like</span></button>
         <?php
            }
         ?>
      </form>
