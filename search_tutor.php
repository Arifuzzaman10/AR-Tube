...
<head>
   ...
   <title>search creator | AR Tube</title>
...
<section class="teachers">
   ...
   <h1 class="heading">expert Content creator</h1>

   <form action="" method="post" class="search-tutor">
      <input type="text" name="search_tutor" maxlength="100" placeholder="search contentent creator..." required>
